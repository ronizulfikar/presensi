...
namespace presensi
{
    public partial class manajerform : Form
    {
        private DatabaseConnector databaseconnector;
        public manajerform(DatabaseConnector dbconnector)
        {
            InitializeComponent();
        ...
        private void manajerform_Load(object sender, EventArgs e)
        {
        ...
        private void tabelketeranganpelajar_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
